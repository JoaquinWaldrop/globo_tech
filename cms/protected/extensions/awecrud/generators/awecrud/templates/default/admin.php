...
<?php endif; ?>
    ...
    function reInstallDatepicker(id, data){
        <?php
            if(isset($cuantos) && count($cuantos) > 0 )
            foreach($cuantos as $cuanto){


                ?>
                jQuery('#<?php echo $cuanto;?>').datepicker(jQuery.extend({showMonthAfterYear:false},jQuery.datepicker.regional[<?php echo '\'".Yii::app()->language."\'';?>],{'showAnim':'fold','format':'yy-mm-dd','dateFormat':'yy-mm-dd','language':<?php echo '\'".Yii::app()->language."\'';?>}));
                $('#<?php echo $cuanto;?>').css('width','100px');
                <?php
            }
        ?>
